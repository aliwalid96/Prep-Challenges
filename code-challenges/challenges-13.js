...
const objectCounter = (obj) => {
    let counter=1;
    const reducer = obj.reduce((previousValue, currentValue) => {
...
const stringReverse = (str) => {
    let newSatatment=[];
    let sipleted=str.split(" ");
    

    sipleted.reduce((previousValue, currentValue) => {
        newSatatment[previousValue - 1] = currentValue;
      return --previousValue;
    }, sipleted.length);
    return newSatatment.join(" ");
